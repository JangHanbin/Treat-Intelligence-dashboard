...
require.config({
    paths: {
      "nbextensions/stix2viz/d3": "/static/stix2viz/d3/d3"
    }
});

require(["domReady!", "/static/stix2viz/stix2viz/stix2viz.js"], function (document, stix2viz) {
    ...
    function vizStixWrapper(content, customConfig) {
      cfg = {
        iconDir: "/static/stix2viz/stix2viz/icons"
      }
